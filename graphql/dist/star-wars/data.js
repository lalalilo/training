...
exports.getDroid = exports.getHuman = exports.getHero = exports.getFriends = exports.getCharacter = void 0;
/**
 ...
 */
const getFriends = (character) => {
    // Notice that GraphQL accepts Arrays of Promises.
    return character.friends.map((id) => (0, exports.getCharacter)(id));
};
exports.getFriends = getFriends;
/**
 * Allows us to fetch the undisputed hero of the Star Wars trilogy, R2-D2.
 */
const getHero = (episode) => {
    if (episode === 5) {
